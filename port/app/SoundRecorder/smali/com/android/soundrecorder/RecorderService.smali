...
.method private localStartRecording(ILjava/lang/String;ZJ)V
    ...
    invoke-virtual {v3, v6, p4, p5}, Lcom/android/soundrecorder/RemainingTimeCalculator;->setFileSizeLimit(Ljava/io/File;J)V
    ...
    invoke-virtual {v3, v6}, Lcom/android/soundrecorder/RemainingTimeCalculator;->setBitRate(I)V

    .line 175
    sget-object v6, Lcom/android/soundrecorder/RecorderService;->mRecorder:Landroid/media/MediaRecorder;
    ...
    :goto_0
    invoke-virtual {v6, v3}, Landroid/media/MediaRecorder;->setAudioSamplingRate(I)V
    ...
    .line 218
    iput-boolean v2, p0, Lcom/android/soundrecorder/RecorderService;->mNeedUpdateRemainingTime:Z
    ...
    :goto_4
    invoke-virtual {v6, v3}, Landroid/media/MediaRecorder;->setAudioEncoder(I)V
    ...
    invoke-direct {p0, v4}, Lcom/android/soundrecorder/RecorderService;->sendErrorBroadcast(I)V
...
.method private sendStateBroadcast()V
    ...
    sget-object v1, Lcom/android/soundrecorder/RecorderService;->mRecorder:Landroid/media/MediaRecorder;
