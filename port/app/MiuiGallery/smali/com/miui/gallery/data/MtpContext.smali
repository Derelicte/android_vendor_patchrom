...
.method public copyAlbum(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Z
    ...
    invoke-static {v7, v8}, Lcom/miui/gallery/util/GalleryUtils;->hasSpaceForSize(J)Z
    ...
    iget-object v7, p0, Lcom/miui/gallery/data/MtpContext;->mClient:Lcom/miui/gallery/data/MtpClient;

    invoke-virtual {v0}, Landroid/mtp/MtpObjectInfo;->getObjectHandle()I

    move-result v8

    invoke-virtual {v7, p1, v8, v5}, Lcom/miui/gallery/data/MtpClient;->importFile(Ljava/lang/String;ILjava/lang/String;)Z
    ...
    .line 135
    iget-object v7, p0, Lcom/miui/gallery/data/MtpContext;->mScannerClient:Lcom/miui/gallery/data/MtpContext$ScannerClient;

    invoke-virtual {v7, v5}, Lcom/miui/gallery/data/MtpContext$ScannerClient;->scanPath(Ljava/lang/String;)V
...
.method public copyFile(Ljava/lang/String;Landroid/mtp/MtpObjectInfo;)Z
    ...
    invoke-static {v4, v5}, Lcom/miui/gallery/util/GalleryUtils;->hasSpaceForSize(J)Z
    ...
    .line 112
    .local v3, objectId:I
    iget-object v4, p0, Lcom/miui/gallery/data/MtpContext;->mClient:Lcom/miui/gallery/data/MtpClient;

    invoke-virtual {v4, p1, v3, v2}, Lcom/miui/gallery/data/MtpClient;->importFile(Ljava/lang/String;ILjava/lang/String;)Z
